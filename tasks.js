...
function getDefaultTasks() {
  return [
    ...
    { id: Date.now() + 4, text: "Digital logic homework", done: false, isToday: false, deadline: '' },
    { id: Date.now() + 5, text: "Complete C note", done: false, isToday: false, deadline: '' },
    { id: Date.now() + 6, text: "Read Chapter 4 of CS book", done: true, isToday: false, deadline: '' },
    { id: Date.now() + 7, text: "Prepare for seminar", done: false, isToday: false, deadline: '2025-06-30' }
  ];
}
